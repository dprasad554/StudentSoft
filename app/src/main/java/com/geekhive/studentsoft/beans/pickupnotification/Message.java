...
public class Message {
    ...
    @Expose
    private List<Object> behaviourNote = null;
    @SerializedName("exam_result")
    @Expose
    private List<Object> examResult = null;
    @SerializedName("_id")
    @Expose
    private String id;
    ...
    public List<Object> getBehaviourNote() {
        return behaviourNote;
    }

    public void setBehaviourNote(List<Object> behaviourNote) {
    ...
    public void setExamResult(List<Object> examResult) {
