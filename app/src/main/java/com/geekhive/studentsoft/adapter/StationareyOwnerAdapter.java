...
public class StationareyOwnerAdapter extends RecyclerView.Adapter {

    Context context;
    StationaryCategory stationaryCategory;
    String url;
    public StationareyOwnerAdapter(Context context, StationaryCategory stationaryCategory) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ((ListViewHolder) holder).VL_psd_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("s_ownerlogin","s_owner");
