...
public class DriverDashboard extends AppCompatActivity {
    ...
    private void openNavigationMenu() {
        ...
        final View bootomNavigation = getLayoutInflater().inflate(R.layout.driver_navigation_menu, null);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (id) {
                    ...
                    case R.id.attendance:
                        //startActivity(new Intent(DriverDashboard.this, AttendnceManagementNonTeaching.class));
                        Intent intent = new Intent(DriverDashboard.this, AttendnceManagementNonTeaching.class);
                        intent.putExtra("ref_id", Prefs.getPrefRefId(DriverDashboard.this));
                        startActivity(intent);
                        bottomSheetDialog.dismiss();
                        break;
                    case R.id.notice:
                        startActivity(new Intent(DriverDashboard.this, NoticeActivity.class));
                        bottomSheetDialog.dismiss();
                        break;
                    case R.id.item6:
                        startActivity(new Intent(DriverDashboard.this, ChangePassword.class));
                        bottomSheetDialog.dismiss();
                        break;
                }
        ...
        vT_psd_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dialogSuccess.isShowing()) {
                    ...
                    Prefs.setUserId(DriverDashboard.this, null);
                    Prefs.setUserType(DriverDashboard.this, null);
