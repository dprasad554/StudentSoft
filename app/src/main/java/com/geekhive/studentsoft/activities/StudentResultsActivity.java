...
public class StudentResultsActivity extends AppCompatActivity implements View.OnClickListener, OnResponseListner {

    @BindView(R.id.backPress)
    ImageView backPress;
    @BindView(R.id.vr_student_results)
    RecyclerView vrStudentResults;
                    ...
                    if (getStudentById.getResult().getMessage() != null){
                        if (getStudentById.getResult().getMessage().getExamResult() != null){
                            if (getStudentById.getResult().getMessage().getExamResult().size() != 0){
                                ...
                                studentResultsAdapter = new StudentResultsAdapter(this,getStudentById);
